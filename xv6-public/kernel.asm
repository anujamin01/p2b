...
801002cd:	e8 7e 3e 00 00       	call   80104150 <sleep>
    while(input.r == input.w){
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 9f 7f 10 80 	movl   $0x80107f9f,(%esp)
...
80100a0e:	e9 dd 38 00 00       	jmp    801042f0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a44:	e8 c7 37 00 00       	call   80104210 <wakeup>
...
80102088:	68 86 7d 10 80       	push   $0x80107d86
...
801022ad:	e8 5e 1f 00 00       	call   80104210 <wakeup>
...
80102369:	e8 e2 1d 00 00       	call   80104150 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102d85:	e8 c6 13 00 00       	call   80104150 <sleep>
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 bf 13 00 00       	call   80104210 <wakeup>
    release(&log.lock);
...
80102f08:	e8 03 13 00 00       	call   80104210 <wakeup>
  release(&log.lock);
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 15 3c 00 00       	call   80106c60 <switchkvm>
  seginit();
8010304b:	e8 80 3b 00 00       	call   80106bd0 <seginit>
  lapicinit();
...
80103081:	e8 ca 40 00 00       	call   80107150 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 3b 3b 00 00       	call   80106bd0 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 b7 2d 00 00       	call   80105e60 <uartinit>
  pinit();         // process table
...
8010355f:	e8 ac 0c 00 00       	call   80104210 <wakeup>
...
801035c4:	e8 47 0c 00 00       	call   80104210 <wakeup>
...
80103638:	e8 d3 0b 00 00       	call   80104210 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 0a 0b 00 00       	call   80104150 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801036ba:	e8 51 0b 00 00       	call   80104210 <wakeup>
  release(&p->lock);
...
80103715:	e8 36 0a 00 00       	call   80104150 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 95 0a 00 00       	call   80104210 <wakeup>
  release(&p->lock);
...
801037f1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 1;
801037f8:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  p->pid = nextpid++;
...
8010380a:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103810:	e8 3b 0e 00 00       	call   80104650 <release>
...
80103832:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103835:	c7 40 14 e2 5a 10 80 	movl   $0x80105ae2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103844:	e8 27 0f 00 00       	call   80104770 <memset>
...
80103955:	68 64 7c 10 80       	push   $0x80107c64
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 58 4e 11 80       	mov    %eax,0x80114e58
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 08 37 00 00       	call   801070d0 <setupkvm>
...
801039e1:	e8 9a 33 00 00       	call   80106d80 <inituvm>
...
80103acb:	e8 a0 31 00 00       	call   80106c70 <switchuvm>
  return 0;
...
80103aea:	e8 01 34 00 00       	call   80106ef0 <allocuvm>
...
80103b0a:	e8 11 35 00 00       	call   80107020 <deallocuvm>
...
80103b58:	e8 63 36 00 00       	call   801071c0 <copyuvm>
...
80103c44:	53                   	push   %ebx
  struct cpu *c = mycpu();
80103c45:	e8 b6 fc ff ff       	call   80103900 <mycpu>
        pstate->inuse[i] = 1;
80103c4a:	8b 1d 54 4e 11 80    	mov    0x80114e54,%ebx
  int i = 0;
...
80103c59:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c5c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if (p->state != UNUSED){ // perhaps needs to be running 
80103c68:	8b 70 0c             	mov    0xc(%eax),%esi
80103c6b:	31 c9                	xor    %ecx,%ecx
80103c6d:	85 f6                	test   %esi,%esi
80103c6f:	0f 95 c1             	setne  %cl
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c72:	05 84 00 00 00       	add    $0x84,%eax
        pstate->inuse[i] = 1;
80103c77:	89 0c 93             	mov    %ecx,(%ebx,%edx,4)
      pstate->tickets[i] = p->priority;
80103c7a:	8b 1d 54 4e 11 80    	mov    0x80114e54,%ebx
80103c80:	8b 70 f8             	mov    -0x8(%eax),%esi
80103c83:	8d 0c 93             	lea    (%ebx,%edx,4),%ecx
      i++;
80103c86:	83 c2 01             	add    $0x1,%edx
      pstate->tickets[i] = p->priority;
80103c89:	89 b1 00 01 00 00    	mov    %esi,0x100(%ecx)
      pstate->pid[i] = p->pid;
80103c8f:	8b 70 8c             	mov    -0x74(%eax),%esi
80103c92:	89 b1 00 02 00 00    	mov    %esi,0x200(%ecx)
      pstate->ticks[i] = p->run_ticks;
80103c98:	8b 70 fc             	mov    -0x4(%eax),%esi
80103c9b:	89 b1 00 03 00 00    	mov    %esi,0x300(%ecx)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca1:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103ca6:	75 c0                	jne    80103c68 <iterate_ptable+0x28>
}
...
80103cde:	e8 cd 09 00 00       	call   801046b0 <acquire>
...
80103cf4:	75 4a                	jne    80103d40 <scheduler+0x90>
      if (p->priority == 1){
80103cf6:	83 7b 7c 01          	cmpl   $0x1,0x7c(%ebx)
80103cfa:	75 44                	jne    80103d40 <scheduler+0x90>
      switchuvm(p);
80103cfc:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103cff:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103d05:	53                   	push   %ebx
80103d06:	e8 65 2f 00 00       	call   80106c70 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d0b:	58                   	pop    %eax
80103d0c:	5a                   	pop    %edx
80103d0d:	ff 73 1c             	push   0x1c(%ebx)
80103d10:	57                   	push   %edi
      p->run_ticks++;
80103d11:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
      p->state = RUNNING;
80103d18:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d1f:	e8 67 0c 00 00       	call   8010498b <swtch>
      switchkvm();
80103d24:	e8 37 2f 00 00       	call   80106c60 <switchkvm>
      c->proc = 0;
...
80103d46:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103d4c:	75 a2                	jne    80103cf0 <scheduler+0x40>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d4e:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103d53:	eb 11                	jmp    80103d66 <scheduler+0xb6>
80103d55:	8d 76 00             	lea    0x0(%esi),%esi
80103d58:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103d5e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103d64:	74 5a                	je     80103dc0 <scheduler+0x110>
      if(p->state != RUNNABLE)
80103d66:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103d6a:	75 ec                	jne    80103d58 <scheduler+0xa8>
      if (p->priority == 0){ // look into second priority
80103d6c:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
80103d6f:	85 c9                	test   %ecx,%ecx
80103d71:	75 e5                	jne    80103d58 <scheduler+0xa8>
      switchuvm(p);
80103d73:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103d76:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103d7c:	53                   	push   %ebx
80103d7d:	e8 ee 2e 00 00       	call   80106c70 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d82:	58                   	pop    %eax
80103d83:	5a                   	pop    %edx
80103d84:	ff 73 1c             	push   0x1c(%ebx)
80103d87:	57                   	push   %edi
      p->run_ticks++;
80103d88:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d8f:	81 c3 84 00 00 00    	add    $0x84,%ebx
      p->state = RUNNING;
80103d95:	c7 43 88 04 00 00 00 	movl   $0x4,-0x78(%ebx)
      swtch(&(c->scheduler), p->context);
80103d9c:	e8 ea 0b 00 00       	call   8010498b <swtch>
      switchkvm();
80103da1:	e8 ba 2e 00 00       	call   80106c60 <switchkvm>
      c->proc = 0;
80103da6:	83 c4 10             	add    $0x10,%esp
80103da9:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103db0:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103db3:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103db9:	75 ab                	jne    80103d66 <scheduler+0xb6>
80103dbb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103dbf:	90                   	nop
    release(&ptable.lock);
80103dc0:	83 ec 0c             	sub    $0xc,%esp
80103dc3:	68 20 2d 11 80       	push   $0x80112d20
80103dc8:	e8 83 08 00 00       	call   80104650 <release>
    sti();
80103dcd:	83 c4 10             	add    $0x10,%esp
80103dd0:	e9 fb fe ff ff       	jmp    80103cd0 <scheduler+0x20>
...
80103de4:	53                   	push   %ebx
  pushcli();
80103de5:	e8 76 07 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103dea:	e8 11 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103def:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103df5:	e8 b6 07 00 00       	call   801045b0 <popcli>
  if(!holding(&ptable.lock))
80103dfa:	83 ec 0c             	sub    $0xc,%esp
80103dfd:	68 20 2d 11 80       	push   $0x80112d20
80103e02:	e8 09 08 00 00       	call   80104610 <holding>
80103e07:	83 c4 10             	add    $0x10,%esp
80103e0a:	85 c0                	test   %eax,%eax
80103e0c:	74 4f                	je     80103e5d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e0e:	e8 ed fa ff ff       	call   80103900 <mycpu>
...
80103e27:	75 41                	jne    80103e6a <sched+0x8a>
  intena = mycpu()->intena;
80103e29:	e8 d2 fa ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e2e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e31:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e37:	e8 c4 fa ff ff       	call   80103900 <mycpu>
80103e3c:	83 ec 08             	sub    $0x8,%esp
80103e3f:	ff 70 04             	push   0x4(%eax)
80103e42:	53                   	push   %ebx
80103e43:	e8 43 0b 00 00       	call   8010498b <swtch>
  mycpu()->intena = intena;
80103e48:	e8 b3 fa ff ff       	call   80103900 <mycpu>
}
...
80103e60:	68 bb 7b 10 80       	push   $0x80107bbb
80103e65:	e8 16 c5 ff ff       	call   80100380 <panic>
    panic("sched interruptible");
80103e6a:	83 ec 0c             	sub    $0xc,%esp
80103e6d:	68 e7 7b 10 80       	push   $0x80107be7
80103e72:	e8 09 c5 ff ff       	call   80100380 <panic>
    panic("sched running");
80103e77:	83 ec 0c             	sub    $0xc,%esp
80103e7a:	68 d9 7b 10 80       	push   $0x80107bd9
80103e7f:	e8 fc c4 ff ff       	call   80100380 <panic>
    panic("sched locks");
80103e84:	83 ec 0c             	sub    $0xc,%esp
80103e87:	68 cd 7b 10 80       	push   $0x80107bcd
...
80103ea6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103ea9:	e8 d2 fa ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103eae:	39 05 58 4e 11 80    	cmp    %eax,0x80114e58
80103eb4:	0f 84 07 01 00 00    	je     80103fc1 <exit+0x121>
80103eba:	89 c3                	mov    %eax,%ebx
80103ebc:	8d 70 28             	lea    0x28(%eax),%esi
80103ebf:	8d 78 68             	lea    0x68(%eax),%edi
80103ec2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[fd]){
80103ec8:	8b 06                	mov    (%esi),%eax
80103eca:	85 c0                	test   %eax,%eax
80103ecc:	74 12                	je     80103ee0 <exit+0x40>
      fileclose(curproc->ofile[fd]);
80103ece:	83 ec 0c             	sub    $0xc,%esp
80103ed1:	50                   	push   %eax
80103ed2:	e8 19 d0 ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
80103ed7:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103edd:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103ee0:	83 c6 04             	add    $0x4,%esi
80103ee3:	39 f7                	cmp    %esi,%edi
80103ee5:	75 e1                	jne    80103ec8 <exit+0x28>
  begin_op();
80103ee7:	e8 74 ee ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103eec:	83 ec 0c             	sub    $0xc,%esp
80103eef:	ff 73 68             	push   0x68(%ebx)
80103ef2:	e8 b9 d9 ff ff       	call   801018b0 <iput>
  end_op();
80103ef7:	e8 d4 ee ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
80103efc:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103f03:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f0a:	e8 a1 07 00 00       	call   801046b0 <acquire>
  wakeup1(curproc->parent);
80103f0f:	8b 53 14             	mov    0x14(%ebx),%edx
...
80103f48:	75 e2                	jne    80103f2c <exit+0x8c>
      p->parent = initproc;
80103f4a:	8b 0d 58 4e 11 80    	mov    0x80114e58,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f50:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103f55:	eb 17                	jmp    80103f6e <exit+0xce>
80103f57:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103f5e:	66 90                	xchg   %ax,%ax
80103f60:	81 c2 84 00 00 00    	add    $0x84,%edx
80103f66:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103f6c:	74 3a                	je     80103fa8 <exit+0x108>
    if(p->parent == curproc){
80103f6e:	39 5a 14             	cmp    %ebx,0x14(%edx)
...
80103f7a:	75 e4                	jne    80103f60 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f7c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103f81:	eb 11                	jmp    80103f94 <exit+0xf4>
80103f83:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f87:	90                   	nop
80103f88:	05 84 00 00 00       	add    $0x84,%eax
80103f8d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103f92:	74 cc                	je     80103f60 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
...
80103fa8:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103faf:	e8 2c fe ff ff       	call   80103de0 <sched>
  panic("zombie exit");
80103fb4:	83 ec 0c             	sub    $0xc,%esp
80103fb7:	68 08 7c 10 80       	push   $0x80107c08
80103fbc:	e8 bf c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fc1:	83 ec 0c             	sub    $0xc,%esp
80103fc4:	68 fb 7b 10 80       	push   $0x80107bfb
80103fc9:	e8 b2 c3 ff ff       	call   80100380 <panic>
...
80104007:	90                   	nop
80104008:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010400e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104014:	74 1e                	je     80104034 <wait+0x64>
      if(p->parent != curproc)
80104016:	39 73 14             	cmp    %esi,0x14(%ebx)
80104019:	75 ed                	jne    80104008 <wait+0x38>
      if(p->state == ZOMBIE){
8010401b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010401f:	74 5f                	je     80104080 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104021:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104027:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010402c:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104032:	75 e2                	jne    80104016 <wait+0x46>
    if(!havekids || curproc->killed){
80104034:	85 c0                	test   %eax,%eax
80104036:	0f 84 9a 00 00 00    	je     801040d6 <wait+0x106>
8010403c:	8b 46 24             	mov    0x24(%esi),%eax
8010403f:	85 c0                	test   %eax,%eax
80104041:	0f 85 8f 00 00 00    	jne    801040d6 <wait+0x106>
  pushcli();
80104047:	e8 14 05 00 00       	call   80104560 <pushcli>
  c = mycpu();
8010404c:	e8 af f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104051:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104057:	e8 54 05 00 00       	call   801045b0 <popcli>
  if(p == 0)
8010405c:	85 db                	test   %ebx,%ebx
8010405e:	0f 84 89 00 00 00    	je     801040ed <wait+0x11d>
  p->chan = chan;
80104064:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104067:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010406e:	e8 6d fd ff ff       	call   80103de0 <sched>
  p->chan = 0;
80104073:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
8010407a:	e9 7b ff ff ff       	jmp    80103ffa <wait+0x2a>
8010407f:	90                   	nop
        kfree(p->kstack);
80104080:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
80104083:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104086:	ff 73 08             	push   0x8(%ebx)
80104089:	e8 32 e4 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010408e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104095:	5a                   	pop    %edx
80104096:	ff 73 04             	push   0x4(%ebx)
80104099:	e8 b2 2f 00 00       	call   80107050 <freevm>
        p->pid = 0;
8010409e:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801040a5:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801040ac:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801040b0:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801040b7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
...
801040eb:	eb e0                	jmp    801040cd <wait+0xfd>
    panic("sleep");
801040ed:	83 ec 0c             	sub    $0xc,%esp
801040f0:	68 14 7c 10 80       	push   $0x80107c14
...
8010410c:	e8 9f 05 00 00       	call   801046b0 <acquire>
  pushcli();
80104111:	e8 4a 04 00 00       	call   80104560 <pushcli>
  c = mycpu();
80104116:	e8 e5 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010411b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104121:	e8 8a 04 00 00       	call   801045b0 <popcli>
  myproc()->state = RUNNABLE;
80104126:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010412d:	e8 ae fc ff ff       	call   80103de0 <sched>
  release(&ptable.lock);
80104132:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104139:	e8 12 05 00 00       	call   80104650 <release>
}
...
8010415c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010415f:	e8 fc 03 00 00       	call   80104560 <pushcli>
  c = mycpu();
80104164:	e8 97 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104169:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010416f:	e8 3c 04 00 00       	call   801045b0 <popcli>
  if(p == 0)
...
801041cb:	5d                   	pop    %ebp
    acquire(lk);
801041cc:	e9 df 04 00 00       	jmp    801046b0 <acquire>
...
801041db:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801041e2:	e8 f9 fb ff ff       	call   80103de0 <sched>
  p->chan = 0;
...
801041f9:	68 1a 7c 10 80       	push   $0x80107c1a
801041fe:	e8 7d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104203:	83 ec 0c             	sub    $0xc,%esp
80104206:	68 14 7c 10 80       	push   $0x80107c14
8010420b:	e8 70 c1 ff ff       	call   80100380 <panic>
...
8010421f:	e8 8c 04 00 00       	call   801046b0 <acquire>
80104224:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104227:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010422c:	eb 0e                	jmp    8010423c <wakeup+0x2c>
8010422e:	66 90                	xchg   %ax,%ax
80104230:	05 84 00 00 00       	add    $0x84,%eax
80104235:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010423a:	74 1e                	je     8010425a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010423c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104240:	75 ee                	jne    80104230 <wakeup+0x20>
80104242:	3b 58 20             	cmp    0x20(%eax),%ebx
80104245:	75 e9                	jne    80104230 <wakeup+0x20>
      p->state = RUNNABLE;
80104247:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010424e:	05 84 00 00 00       	add    $0x84,%eax
80104253:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104258:	75 e2                	jne    8010423c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010425a:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80104261:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104264:	c9                   	leave  
  release(&ptable.lock);
80104265:	e9 e6 03 00 00       	jmp    80104650 <release>
...
8010427f:	e8 2c 04 00 00       	call   801046b0 <acquire>
...
80104290:	05 84 00 00 00       	add    $0x84,%eax
80104295:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010429a:	74 34                	je     801042d0 <kill+0x60>
    if(p->pid == pid){
...
801042bd:	e8 8e 03 00 00       	call   80104650 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801042d8:	e8 73 03 00 00       	call   80104650 <release>
}
...
8010430b:	68 9f 7f 10 80       	push   $0x80107f9f
80104310:	e8 8b c3 ff ff       	call   801006a0 <cprintf>
80104315:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104318:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010431e:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
80104324:	0f 84 7e 00 00 00    	je     801043a8 <procdump+0xb8>
    if(p->state == UNUSED)
8010432a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010432d:	85 c0                	test   %eax,%eax
8010432f:	74 e7                	je     80104318 <procdump+0x28>
      state = "???";
80104331:	ba 2b 7c 10 80       	mov    $0x80107c2b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104336:	83 f8 05             	cmp    $0x5,%eax
80104339:	77 11                	ja     8010434c <procdump+0x5c>
8010433b:	8b 14 85 8c 7c 10 80 	mov    -0x7fef8374(,%eax,4),%edx
      state = "???";
80104342:	b8 2b 7c 10 80       	mov    $0x80107c2b,%eax
80104347:	85 d2                	test   %edx,%edx
80104349:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010434c:	53                   	push   %ebx
8010434d:	52                   	push   %edx
8010434e:	ff 73 a4             	push   -0x5c(%ebx)
80104351:	68 2f 7c 10 80       	push   $0x80107c2f
80104356:	e8 45 c3 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
8010435b:	83 c4 10             	add    $0x10,%esp
8010435e:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
...
8010436e:	8b 43 b0             	mov    -0x50(%ebx),%eax
...
8010438d:	68 81 76 10 80       	push   $0x80107681
80104392:	e8 09 c3 ff ff       	call   801006a0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801043ba:	68 a4 7c 10 80       	push   $0x80107ca4
...
80104415:	e8 36 fd ff ff       	call   80104150 <sleep>
  while (lk->locked) {
...
801045f5:	68 af 7c 10 80       	push   $0x80107caf
801045fa:	e8 81 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045ff:	83 ec 0c             	sub    $0xc,%esp
80104602:	68 c6 7c 10 80       	push   $0x80107cc6
...
8010466b:	68 cd 7c 10 80       	push   $0x80107ccd
...
80104760:	68 d5 7c 10 80       	push   $0x80107cd5
...
80104b87:	83 fa 16             	cmp    $0x16,%edx
80104b8a:	77 24                	ja     80104bb0 <syscall+0x40>
80104b8c:	8b 14 85 00 7d 10 80 	mov    -0x7fef8300(,%eax,4),%edx
...
80104bb8:	68 dd 7c 10 80       	push   $0x80107cdd
...
80104d14:	68 7c 7d 10 80       	push   $0x80107d7c
...
80104d2c:	68 7b 7d 10 80       	push   $0x80107d7b
...
80104d41:	68 6f 7d 10 80       	push   $0x80107d6f
...
80104d5f:	68 7e 7d 10 80       	push   $0x80107d7e
80104d64:	e8 17 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d69:	83 ec 0c             	sub    $0xc,%esp
80104d6c:	68 60 7d 10 80       	push   $0x80107d60
...
8010516d:	58                   	pop    %eax
8010516e:	5a                   	pop    %edx
8010516f:	68 7c 7d 10 80       	push   $0x80107d7c
...
80105188:	68 7b 7d 10 80       	push   $0x80107d7b
...
801057a4:	83 ec 14             	sub    $0x14,%esp
  struct proc* curproc = myproc();
801057a7:	e8 d4 e1 ff ff       	call   80103980 <myproc>
  int ticket;
...
801057b7:	e8 74 f2 ff ff       	call   80104a30 <argint>
801057bc:	83 c4 10             	add    $0x10,%esp
801057bf:	85 c0                	test   %eax,%eax
801057c1:	78 2d                	js     801057f0 <sys_settickets+0x50>
    return -1;
  
  if (ticket < 0 || ticket > 1){
801057c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057c6:	83 f8 01             	cmp    $0x1,%eax
801057c9:	77 25                	ja     801057f0 <sys_settickets+0x50>
    return -1;
  }
  if (ticket == 0){
801057cb:	85 c0                	test   %eax,%eax
801057cd:	75 11                	jne    801057e0 <sys_settickets+0x40>
    curproc->priority = 0;
801057cf:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
    curproc->priority = 1;
  }
  return 0;
...
801057d6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801057d9:	c9                   	leave  
801057da:	c3                   	ret    
801057db:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801057df:	90                   	nop
    curproc->priority = 1;
801057e0:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  return 0;
...
int sys_getpinfo(struct pstat *){
80105808:	83 ec 14             	sub    $0x14,%esp
  if(argptr(0, (void*)&currentState,sizeof(*currentState)) < 0)
8010580b:	68 00 04 00 00       	push   $0x400
80105810:	50                   	push   %eax
80105811:	6a 00                	push   $0x0
80105813:	e8 68 f2 ff ff       	call   80104a80 <argptr>
80105818:	83 c4 10             	add    $0x10,%esp
8010581b:	85 c0                	test   %eax,%eax
8010581d:	78 55                	js     80105874 <sys_getpinfo+0x74>
    return -1;
  struct pstat* pstate = iterate_ptable();
8010581f:	e8 1c e4 ff ff       	call   80103c40 <iterate_ptable>
  for(int i = 0; i < NPROC; i++){
   currentState->inuse[i] = pstate->inuse[i];
80105824:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  struct pstat* pstate = iterate_ptable();
80105827:	89 c2                	mov    %eax,%edx
  for(int i = 0; i < NPROC; i++){
80105829:	31 c0                	xor    %eax,%eax
8010582b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010582f:	90                   	nop
   currentState->inuse[i] = pstate->inuse[i];
80105830:	8b 0c 82             	mov    (%edx,%eax,4),%ecx
80105833:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
   currentState->pid[i] = pstate->pid[i];
80105836:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105839:	8b b4 82 00 02 00 00 	mov    0x200(%edx,%eax,4),%esi
80105840:	8d 0c 83             	lea    (%ebx,%eax,4),%ecx
80105843:	89 b1 00 02 00 00    	mov    %esi,0x200(%ecx)
   currentState->tickets[i] = pstate->tickets[i];
80105849:	8b b4 82 00 01 00 00 	mov    0x100(%edx,%eax,4),%esi
80105850:	89 b1 00 01 00 00    	mov    %esi,0x100(%ecx)
   currentState->ticks[i] = pstate->ticks[i];
80105856:	8b b4 82 00 03 00 00 	mov    0x300(%edx,%eax,4),%esi
  for(int i = 0; i < NPROC; i++){
8010585d:	83 c0 01             	add    $0x1,%eax
   currentState->ticks[i] = pstate->ticks[i];
80105860:	89 b1 00 03 00 00    	mov    %esi,0x300(%ecx)
  for(int i = 0; i < NPROC; i++){
80105866:	83 f8 40             	cmp    $0x40,%eax
80105869:	75 c5                	jne    80105830 <sys_getpinfo+0x30>
  }
...
80105879:	eb f2                	jmp    8010586d <sys_getpinfo+0x6d>
8010587b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010587f:	90                   	nop

80105880 <sys_mprotect>:
...
8010588e:	e8 ed f1 ff ff       	call   80104a80 <argptr>
80105893:	83 c4 10             	add    $0x10,%esp
80105896:	85 c0                	test   %eax,%eax
80105898:	78 2e                	js     801058c8 <sys_mprotect+0x48>
    return -1;
  int len;
...
801058de:	e8 9d f1 ff ff       	call   80104a80 <argptr>
801058e3:	83 c4 10             	add    $0x10,%esp
801058e6:	85 c0                	test   %eax,%eax
801058e8:	78 2e                	js     80105918 <sys_munprotect+0x48>
    return -1;
  int len;
  if(argint(1, &len) < 0) // if invalid arg
...
{
  return fork();
80105920:	e9 fb e1 ff ff       	jmp    80103b20 <fork>
...
80105933:	83 ec 08             	sub    $0x8,%esp
  exit();
80105936:	e8 65 e5 ff ff       	call   80103ea0 <exit>
...
{
  return wait();
80105940:	e9 8b e6 ff ff       	jmp    80103fd0 <wait>
...
8010595c:	e8 cf f0 ff ff       	call   80104a30 <argint>
...
8010596e:	e8 fd e8 ff ff       	call   80104270 <kill>
...
801059ad:	e8 7e f0 ff ff       	call   80104a30 <argint>
...
801059fd:	e8 2e f0 ff ff       	call   80104a30 <argint>
...
80105a10:	68 80 4e 11 80       	push   $0x80114e80
80105a15:	e8 96 ec ff ff       	call   801046b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a1a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a1d:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  while(ticks - ticks0 < n){
...
80105a33:	68 80 4e 11 80       	push   $0x80114e80
80105a38:	68 60 4e 11 80       	push   $0x80114e60
80105a3d:	e8 0e e7 ff ff       	call   80104150 <sleep>
  while(ticks - ticks0 < n){
80105a42:	a1 60 4e 11 80       	mov    0x80114e60,%eax
...
80105a60:	68 80 4e 11 80       	push   $0x80114e80
80105a65:	e8 e6 eb ff ff       	call   80104650 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105a83:	68 80 4e 11 80       	push   $0x80114e80
80105a88:	e8 c3 eb ff ff       	call   80104650 <release>
  return 0;
...
80105aa4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105aa7:	68 80 4e 11 80       	push   $0x80114e80
80105aac:	e8 ff eb ff ff       	call   801046b0 <acquire>
  xticks = ticks;
80105ab1:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  release(&tickslock);
80105ab7:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105abe:	e8 8d eb ff ff       	call   80104650 <release>
  return xticks;
}
...
80105acb:	06                   	push   %es
  pushl %fs
80105acc:	0f a0                	push   %fs
  pushl %gs
80105ace:	0f a8                	push   %gs
  pushal
80105ad0:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105ad1:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105ad5:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105ad7:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105ad9:	54                   	push   %esp
  call trap
80105ada:	e8 c1 00 00 00       	call   80105ba0 <trap>
  addl $4, %esp
80105adf:	83 c4 04             	add    $0x4,%esp
...
80105ae2:	61                   	popa   
  popl %gs
80105ae3:	0f a9                	pop    %gs
  popl %fs
80105ae5:	0f a1                	pop    %fs
  popl %es
80105ae7:	07                   	pop    %es
  popl %ds
80105ae8:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105ae9:	83 c4 08             	add    $0x8,%esp
  iret
80105aec:	cf                   	iret   
...
80105b00:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105b07:	c7 04 c5 c2 4e 11 80 	movl   $0x8e000008,-0x7feeb13e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 c0 4e 11 	mov    %dx,-0x7feeb140(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 c6 4e 11 	mov    %dx,-0x7feeb13a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b2f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b32:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80105b37:	c7 05 c2 50 11 80 08 	movl   $0xef000008,0x801150c2
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 c1 7d 10 80       	push   $0x80107dc1
80105b46:	68 80 4e 11 80       	push   $0x80114e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 c0 50 11 80    	mov    %ax,0x801150c0
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 c6 50 11 80    	mov    %ax,0x801150c6
  initlock(&tickslock, "time");
80105b5a:	e8 81 e9 ff ff       	call   801044e0 <initlock>
}
...
80105b7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b7f:	b8 c0 4e 11 80       	mov    $0x80114ec0,%eax
...
80105bc4:	ff 24 85 68 7e 10 80 	jmp    *-0x7fef8198(,%eax,4)
...
80105bcf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105bd0:	e8 6b c6 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105be3:	e8 98 dd ff ff       	call   80103980 <myproc>
...
80105c21:	e8 5a dd ff ff       	call   80103980 <myproc>
...
80105c50:	e8 2b dd ff ff       	call   80103980 <myproc>
...
80105c70:	e8 eb dc ff ff       	call   80103960 <cpuid>
...
80105c89:	e8 f2 dc ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ca5:	68 24 7e 10 80       	push   $0x80107e24
80105caa:	e8 f1 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105caf:	83 c4 20             	add    $0x20,%esp
80105cb2:	e8 c9 dc ff ff       	call   80103980 <myproc>
...
80105cd4:	0f 85 3e ff ff ff    	jne    80105c18 <trap+0x78>
    yield();
80105cda:	e8 21 e4 ff ff       	call   80104100 <yield>
...
80105cef:	e8 6c dc ff ff       	call   80103960 <cpuid>
80105cf4:	57                   	push   %edi
80105cf5:	56                   	push   %esi
80105cf6:	50                   	push   %eax
80105cf7:	68 cc 7d 10 80       	push   $0x80107dcc
80105cfc:	e8 9f a9 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105d01:	e8 0a cc ff ff       	call   80102910 <lapiceoi>
    break;
...
80105d35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d38:	e8 33 ee ff ff       	call   80104b70 <syscall>
    if(myproc()->killed)
80105d3d:	e8 3e dc ff ff       	call   80103980 <myproc>
...
80105d53:	5d                   	pop    %ebp
      exit();
80105d54:	e9 47 e1 ff ff       	jmp    80103ea0 <exit>
...
80105d65:	e8 a6 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d6a:	e8 11 dc ff ff       	call   80103980 <myproc>
...
80105d9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105da0:	e8 bb db ff ff       	call   80103960 <cpuid>
80105da5:	85 c0                	test   %eax,%eax
80105da7:	0f 85 28 fe ff ff    	jne    80105bd5 <trap+0x35>
      acquire(&tickslock);
80105dad:	83 ec 0c             	sub    $0xc,%esp
80105db0:	68 80 4e 11 80       	push   $0x80114e80
80105db5:	e8 f6 e8 ff ff       	call   801046b0 <acquire>
      wakeup(&ticks);
80105dba:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
      ticks++;
80105dc1:	83 05 60 4e 11 80 01 	addl   $0x1,0x80114e60
      wakeup(&ticks);
80105dc8:	e8 43 e4 ff ff       	call   80104210 <wakeup>
      release(&tickslock);
80105dcd:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105dd4:	e8 77 e8 ff ff       	call   80104650 <release>
...
{
  if(!uart)
80105e30:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
80105eb7:	74 78                	je     80105f31 <uartinit+0xd1>
  uart = 1;
80105eb9:	c7 05 c0 56 11 80 01 	movl   $0x1,0x801156c0
80105ec0:	00 00 00 
...
80105ecc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ecf:	bf e8 7e 10 80       	mov    $0x80107ee8,%edi
80105ed4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105ed9:	6a 00                	push   $0x0
80105edb:	6a 04                	push   $0x4
80105edd:	e8 9e c5 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105ee9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105ef0:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
80105f40 <uartputc>:
  if(!uart)
80105f40:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
80105fb7:	6a 00                	push   $0x0
  jmp alltraps
80105fb9:	e9 0c fb ff ff       	jmp    80105aca <alltraps>
...
80105fc0:	6a 01                	push   $0x1
  jmp alltraps
80105fc2:	e9 03 fb ff ff       	jmp    80105aca <alltraps>
...
80105fc9:	6a 02                	push   $0x2
  jmp alltraps
80105fcb:	e9 fa fa ff ff       	jmp    80105aca <alltraps>
...
80105fd2:	6a 03                	push   $0x3
  jmp alltraps
80105fd4:	e9 f1 fa ff ff       	jmp    80105aca <alltraps>
...
80105fdb:	6a 04                	push   $0x4
  jmp alltraps
80105fdd:	e9 e8 fa ff ff       	jmp    80105aca <alltraps>
...
80105fe4:	6a 05                	push   $0x5
  jmp alltraps
80105fe6:	e9 df fa ff ff       	jmp    80105aca <alltraps>
...
80105fed:	6a 06                	push   $0x6
  jmp alltraps
80105fef:	e9 d6 fa ff ff       	jmp    80105aca <alltraps>
...
80105ff6:	6a 07                	push   $0x7
  jmp alltraps
80105ff8:	e9 cd fa ff ff       	jmp    80105aca <alltraps>
...
80105ffd:	6a 08                	push   $0x8
  jmp alltraps
80105fff:	e9 c6 fa ff ff       	jmp    80105aca <alltraps>
...
80106006:	6a 09                	push   $0x9
  jmp alltraps
80106008:	e9 bd fa ff ff       	jmp    80105aca <alltraps>
...
8010600d:	6a 0a                	push   $0xa
  jmp alltraps
8010600f:	e9 b6 fa ff ff       	jmp    80105aca <alltraps>
...
80106014:	6a 0b                	push   $0xb
  jmp alltraps
80106016:	e9 af fa ff ff       	jmp    80105aca <alltraps>
...
8010601b:	6a 0c                	push   $0xc
  jmp alltraps
8010601d:	e9 a8 fa ff ff       	jmp    80105aca <alltraps>
...
80106022:	6a 0d                	push   $0xd
  jmp alltraps
80106024:	e9 a1 fa ff ff       	jmp    80105aca <alltraps>
...
80106029:	6a 0e                	push   $0xe
  jmp alltraps
8010602b:	e9 9a fa ff ff       	jmp    80105aca <alltraps>
...
80106032:	6a 0f                	push   $0xf
  jmp alltraps
80106034:	e9 91 fa ff ff       	jmp    80105aca <alltraps>
...
8010603b:	6a 10                	push   $0x10
  jmp alltraps
8010603d:	e9 88 fa ff ff       	jmp    80105aca <alltraps>
...
80106042:	6a 11                	push   $0x11
  jmp alltraps
80106044:	e9 81 fa ff ff       	jmp    80105aca <alltraps>
...
8010604b:	6a 12                	push   $0x12
  jmp alltraps
8010604d:	e9 78 fa ff ff       	jmp    80105aca <alltraps>
...
80106054:	6a 13                	push   $0x13
  jmp alltraps
80106056:	e9 6f fa ff ff       	jmp    80105aca <alltraps>
...
8010605d:	6a 14                	push   $0x14
  jmp alltraps
8010605f:	e9 66 fa ff ff       	jmp    80105aca <alltraps>
...
80106066:	6a 15                	push   $0x15
  jmp alltraps
80106068:	e9 5d fa ff ff       	jmp    80105aca <alltraps>
...
8010606f:	6a 16                	push   $0x16
  jmp alltraps
80106071:	e9 54 fa ff ff       	jmp    80105aca <alltraps>
...
80106078:	6a 17                	push   $0x17
  jmp alltraps
8010607a:	e9 4b fa ff ff       	jmp    80105aca <alltraps>
...
80106081:	6a 18                	push   $0x18
  jmp alltraps
80106083:	e9 42 fa ff ff       	jmp    80105aca <alltraps>
...
8010608a:	6a 19                	push   $0x19
  jmp alltraps
8010608c:	e9 39 fa ff ff       	jmp    80105aca <alltraps>
...
80106093:	6a 1a                	push   $0x1a
  jmp alltraps
80106095:	e9 30 fa ff ff       	jmp    80105aca <alltraps>
...
8010609c:	6a 1b                	push   $0x1b
  jmp alltraps
8010609e:	e9 27 fa ff ff       	jmp    80105aca <alltraps>
...
801060a5:	6a 1c                	push   $0x1c
  jmp alltraps
801060a7:	e9 1e fa ff ff       	jmp    80105aca <alltraps>
...
801060ae:	6a 1d                	push   $0x1d
  jmp alltraps
801060b0:	e9 15 fa ff ff       	jmp    80105aca <alltraps>
...
801060b7:	6a 1e                	push   $0x1e
  jmp alltraps
801060b9:	e9 0c fa ff ff       	jmp    80105aca <alltraps>
...
801060c0:	6a 1f                	push   $0x1f
  jmp alltraps
801060c2:	e9 03 fa ff ff       	jmp    80105aca <alltraps>
...
801060c9:	6a 20                	push   $0x20
  jmp alltraps
801060cb:	e9 fa f9 ff ff       	jmp    80105aca <alltraps>
...
801060d2:	6a 21                	push   $0x21
  jmp alltraps
801060d4:	e9 f1 f9 ff ff       	jmp    80105aca <alltraps>
...
801060db:	6a 22                	push   $0x22
  jmp alltraps
801060dd:	e9 e8 f9 ff ff       	jmp    80105aca <alltraps>
...
801060e4:	6a 23                	push   $0x23
  jmp alltraps
801060e6:	e9 df f9 ff ff       	jmp    80105aca <alltraps>
...
801060ed:	6a 24                	push   $0x24
  jmp alltraps
801060ef:	e9 d6 f9 ff ff       	jmp    80105aca <alltraps>
...
801060f6:	6a 25                	push   $0x25
  jmp alltraps
801060f8:	e9 cd f9 ff ff       	jmp    80105aca <alltraps>
...
801060ff:	6a 26                	push   $0x26
  jmp alltraps
80106101:	e9 c4 f9 ff ff       	jmp    80105aca <alltraps>
...
80106108:	6a 27                	push   $0x27
  jmp alltraps
8010610a:	e9 bb f9 ff ff       	jmp    80105aca <alltraps>
...
80106111:	6a 28                	push   $0x28
  jmp alltraps
80106113:	e9 b2 f9 ff ff       	jmp    80105aca <alltraps>
...
8010611a:	6a 29                	push   $0x29
  jmp alltraps
8010611c:	e9 a9 f9 ff ff       	jmp    80105aca <alltraps>
...
80106123:	6a 2a                	push   $0x2a
  jmp alltraps
80106125:	e9 a0 f9 ff ff       	jmp    80105aca <alltraps>
...
8010612c:	6a 2b                	push   $0x2b
  jmp alltraps
8010612e:	e9 97 f9 ff ff       	jmp    80105aca <alltraps>
...
80106135:	6a 2c                	push   $0x2c
  jmp alltraps
80106137:	e9 8e f9 ff ff       	jmp    80105aca <alltraps>
...
8010613e:	6a 2d                	push   $0x2d
  jmp alltraps
80106140:	e9 85 f9 ff ff       	jmp    80105aca <alltraps>
...
80106147:	6a 2e                	push   $0x2e
  jmp alltraps
80106149:	e9 7c f9 ff ff       	jmp    80105aca <alltraps>
...
80106150:	6a 2f                	push   $0x2f
  jmp alltraps
80106152:	e9 73 f9 ff ff       	jmp    80105aca <alltraps>
...
80106159:	6a 30                	push   $0x30
  jmp alltraps
8010615b:	e9 6a f9 ff ff       	jmp    80105aca <alltraps>
...
80106162:	6a 31                	push   $0x31
  jmp alltraps
80106164:	e9 61 f9 ff ff       	jmp    80105aca <alltraps>
...
8010616b:	6a 32                	push   $0x32
  jmp alltraps
8010616d:	e9 58 f9 ff ff       	jmp    80105aca <alltraps>
...
80106174:	6a 33                	push   $0x33
  jmp alltraps
80106176:	e9 4f f9 ff ff       	jmp    80105aca <alltraps>
...
8010617d:	6a 34                	push   $0x34
  jmp alltraps
8010617f:	e9 46 f9 ff ff       	jmp    80105aca <alltraps>
...
80106186:	6a 35                	push   $0x35
  jmp alltraps
80106188:	e9 3d f9 ff ff       	jmp    80105aca <alltraps>
...
8010618f:	6a 36                	push   $0x36
  jmp alltraps
80106191:	e9 34 f9 ff ff       	jmp    80105aca <alltraps>
...
80106198:	6a 37                	push   $0x37
  jmp alltraps
8010619a:	e9 2b f9 ff ff       	jmp    80105aca <alltraps>
...
801061a1:	6a 38                	push   $0x38
  jmp alltraps
801061a3:	e9 22 f9 ff ff       	jmp    80105aca <alltraps>
...
801061aa:	6a 39                	push   $0x39
  jmp alltraps
801061ac:	e9 19 f9 ff ff       	jmp    80105aca <alltraps>
...
801061b3:	6a 3a                	push   $0x3a
  jmp alltraps
801061b5:	e9 10 f9 ff ff       	jmp    80105aca <alltraps>
...
801061bc:	6a 3b                	push   $0x3b
  jmp alltraps
801061be:	e9 07 f9 ff ff       	jmp    80105aca <alltraps>
...
801061c5:	6a 3c                	push   $0x3c
  jmp alltraps
801061c7:	e9 fe f8 ff ff       	jmp    80105aca <alltraps>
...
801061ce:	6a 3d                	push   $0x3d
  jmp alltraps
801061d0:	e9 f5 f8 ff ff       	jmp    80105aca <alltraps>
...
801061d7:	6a 3e                	push   $0x3e
  jmp alltraps
801061d9:	e9 ec f8 ff ff       	jmp    80105aca <alltraps>
...
801061e0:	6a 3f                	push   $0x3f
  jmp alltraps
801061e2:	e9 e3 f8 ff ff       	jmp    80105aca <alltraps>
...
801061e9:	6a 40                	push   $0x40
  jmp alltraps
801061eb:	e9 da f8 ff ff       	jmp    80105aca <alltraps>
...
801061f2:	6a 41                	push   $0x41
  jmp alltraps
801061f4:	e9 d1 f8 ff ff       	jmp    80105aca <alltraps>
...
801061fb:	6a 42                	push   $0x42
  jmp alltraps
801061fd:	e9 c8 f8 ff ff       	jmp    80105aca <alltraps>
...
80106204:	6a 43                	push   $0x43
  jmp alltraps
80106206:	e9 bf f8 ff ff       	jmp    80105aca <alltraps>
...
8010620d:	6a 44                	push   $0x44
  jmp alltraps
8010620f:	e9 b6 f8 ff ff       	jmp    80105aca <alltraps>
...
80106216:	6a 45                	push   $0x45
  jmp alltraps
80106218:	e9 ad f8 ff ff       	jmp    80105aca <alltraps>
...
8010621f:	6a 46                	push   $0x46
  jmp alltraps
80106221:	e9 a4 f8 ff ff       	jmp    80105aca <alltraps>
...
80106228:	6a 47                	push   $0x47
  jmp alltraps
8010622a:	e9 9b f8 ff ff       	jmp    80105aca <alltraps>
...
80106231:	6a 48                	push   $0x48
  jmp alltraps
80106233:	e9 92 f8 ff ff       	jmp    80105aca <alltraps>
...
8010623a:	6a 49                	push   $0x49
  jmp alltraps
8010623c:	e9 89 f8 ff ff       	jmp    80105aca <alltraps>
...
80106243:	6a 4a                	push   $0x4a
  jmp alltraps
80106245:	e9 80 f8 ff ff       	jmp    80105aca <alltraps>
...
8010624c:	6a 4b                	push   $0x4b
  jmp alltraps
8010624e:	e9 77 f8 ff ff       	jmp    80105aca <alltraps>
...
80106255:	6a 4c                	push   $0x4c
  jmp alltraps
80106257:	e9 6e f8 ff ff       	jmp    80105aca <alltraps>
...
8010625e:	6a 4d                	push   $0x4d
  jmp alltraps
80106260:	e9 65 f8 ff ff       	jmp    80105aca <alltraps>
...
80106267:	6a 4e                	push   $0x4e
  jmp alltraps
80106269:	e9 5c f8 ff ff       	jmp    80105aca <alltraps>
...
80106270:	6a 4f                	push   $0x4f
  jmp alltraps
80106272:	e9 53 f8 ff ff       	jmp    80105aca <alltraps>
...
80106279:	6a 50                	push   $0x50
  jmp alltraps
8010627b:	e9 4a f8 ff ff       	jmp    80105aca <alltraps>
...
80106282:	6a 51                	push   $0x51
  jmp alltraps
80106284:	e9 41 f8 ff ff       	jmp    80105aca <alltraps>
...
8010628b:	6a 52                	push   $0x52
  jmp alltraps
8010628d:	e9 38 f8 ff ff       	jmp    80105aca <alltraps>
...
80106294:	6a 53                	push   $0x53
  jmp alltraps
80106296:	e9 2f f8 ff ff       	jmp    80105aca <alltraps>
...
8010629d:	6a 54                	push   $0x54
  jmp alltraps
8010629f:	e9 26 f8 ff ff       	jmp    80105aca <alltraps>
...
801062a6:	6a 55                	push   $0x55
  jmp alltraps
801062a8:	e9 1d f8 ff ff       	jmp    80105aca <alltraps>
...
801062af:	6a 56                	push   $0x56
  jmp alltraps
801062b1:	e9 14 f8 ff ff       	jmp    80105aca <alltraps>
...
801062b8:	6a 57                	push   $0x57
  jmp alltraps
801062ba:	e9 0b f8 ff ff       	jmp    80105aca <alltraps>
...
801062c1:	6a 58                	push   $0x58
  jmp alltraps
801062c3:	e9 02 f8 ff ff       	jmp    80105aca <alltraps>
...
801062ca:	6a 59                	push   $0x59
  jmp alltraps
801062cc:	e9 f9 f7 ff ff       	jmp    80105aca <alltraps>
...
801062d3:	6a 5a                	push   $0x5a
  jmp alltraps
801062d5:	e9 f0 f7 ff ff       	jmp    80105aca <alltraps>
...
801062dc:	6a 5b                	push   $0x5b
  jmp alltraps
801062de:	e9 e7 f7 ff ff       	jmp    80105aca <alltraps>
...
801062e5:	6a 5c                	push   $0x5c
  jmp alltraps
801062e7:	e9 de f7 ff ff       	jmp    80105aca <alltraps>
...
801062ee:	6a 5d                	push   $0x5d
  jmp alltraps
801062f0:	e9 d5 f7 ff ff       	jmp    80105aca <alltraps>
...
801062f7:	6a 5e                	push   $0x5e
  jmp alltraps
801062f9:	e9 cc f7 ff ff       	jmp    80105aca <alltraps>
...
80106300:	6a 5f                	push   $0x5f
  jmp alltraps
80106302:	e9 c3 f7 ff ff       	jmp    80105aca <alltraps>
...
80106309:	6a 60                	push   $0x60
  jmp alltraps
8010630b:	e9 ba f7 ff ff       	jmp    80105aca <alltraps>
...
80106312:	6a 61                	push   $0x61
  jmp alltraps
80106314:	e9 b1 f7 ff ff       	jmp    80105aca <alltraps>
...
8010631b:	6a 62                	push   $0x62
  jmp alltraps
8010631d:	e9 a8 f7 ff ff       	jmp    80105aca <alltraps>
...
80106324:	6a 63                	push   $0x63
  jmp alltraps
80106326:	e9 9f f7 ff ff       	jmp    80105aca <alltraps>
...
8010632d:	6a 64                	push   $0x64
  jmp alltraps
8010632f:	e9 96 f7 ff ff       	jmp    80105aca <alltraps>
...
80106336:	6a 65                	push   $0x65
  jmp alltraps
80106338:	e9 8d f7 ff ff       	jmp    80105aca <alltraps>
...
8010633f:	6a 66                	push   $0x66
  jmp alltraps
80106341:	e9 84 f7 ff ff       	jmp    80105aca <alltraps>
...
80106348:	6a 67                	push   $0x67
  jmp alltraps
8010634a:	e9 7b f7 ff ff       	jmp    80105aca <alltraps>
...
80106351:	6a 68                	push   $0x68
  jmp alltraps
80106353:	e9 72 f7 ff ff       	jmp    80105aca <alltraps>
...
8010635a:	6a 69                	push   $0x69
  jmp alltraps
8010635c:	e9 69 f7 ff ff       	jmp    80105aca <alltraps>
...
80106363:	6a 6a                	push   $0x6a
  jmp alltraps
80106365:	e9 60 f7 ff ff       	jmp    80105aca <alltraps>
...
8010636c:	6a 6b                	push   $0x6b
  jmp alltraps
8010636e:	e9 57 f7 ff ff       	jmp    80105aca <alltraps>
...
80106375:	6a 6c                	push   $0x6c
  jmp alltraps
80106377:	e9 4e f7 ff ff       	jmp    80105aca <alltraps>
...
8010637e:	6a 6d                	push   $0x6d
  jmp alltraps
80106380:	e9 45 f7 ff ff       	jmp    80105aca <alltraps>
...
80106387:	6a 6e                	push   $0x6e
  jmp alltraps
80106389:	e9 3c f7 ff ff       	jmp    80105aca <alltraps>
...
80106390:	6a 6f                	push   $0x6f
  jmp alltraps
80106392:	e9 33 f7 ff ff       	jmp    80105aca <alltraps>
...
80106399:	6a 70                	push   $0x70
  jmp alltraps
8010639b:	e9 2a f7 ff ff       	jmp    80105aca <alltraps>
...
801063a2:	6a 71                	push   $0x71
  jmp alltraps
801063a4:	e9 21 f7 ff ff       	jmp    80105aca <alltraps>
...
801063ab:	6a 72                	push   $0x72
  jmp alltraps
801063ad:	e9 18 f7 ff ff       	jmp    80105aca <alltraps>
...
801063b4:	6a 73                	push   $0x73
  jmp alltraps
801063b6:	e9 0f f7 ff ff       	jmp    80105aca <alltraps>
...
801063bd:	6a 74                	push   $0x74
  jmp alltraps
801063bf:	e9 06 f7 ff ff       	jmp    80105aca <alltraps>
...
801063c6:	6a 75                	push   $0x75
  jmp alltraps
801063c8:	e9 fd f6 ff ff       	jmp    80105aca <alltraps>
...
801063cf:	6a 76                	push   $0x76
  jmp alltraps
801063d1:	e9 f4 f6 ff ff       	jmp    80105aca <alltraps>
...
801063d8:	6a 77                	push   $0x77
  jmp alltraps
801063da:	e9 eb f6 ff ff       	jmp    80105aca <alltraps>
...
801063e1:	6a 78                	push   $0x78
  jmp alltraps
801063e3:	e9 e2 f6 ff ff       	jmp    80105aca <alltraps>
...
801063ea:	6a 79                	push   $0x79
  jmp alltraps
801063ec:	e9 d9 f6 ff ff       	jmp    80105aca <alltraps>
...
801063f3:	6a 7a                	push   $0x7a
  jmp alltraps
801063f5:	e9 d0 f6 ff ff       	jmp    80105aca <alltraps>
...
801063fc:	6a 7b                	push   $0x7b
  jmp alltraps
801063fe:	e9 c7 f6 ff ff       	jmp    80105aca <alltraps>
...
80106405:	6a 7c                	push   $0x7c
  jmp alltraps
80106407:	e9 be f6 ff ff       	jmp    80105aca <alltraps>
...
8010640e:	6a 7d                	push   $0x7d
  jmp alltraps
80106410:	e9 b5 f6 ff ff       	jmp    80105aca <alltraps>
...
80106417:	6a 7e                	push   $0x7e
  jmp alltraps
80106419:	e9 ac f6 ff ff       	jmp    80105aca <alltraps>
...
80106420:	6a 7f                	push   $0x7f
  jmp alltraps
80106422:	e9 a3 f6 ff ff       	jmp    80105aca <alltraps>
...
80106429:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010642e:	e9 97 f6 ff ff       	jmp    80105aca <alltraps>
...
80106435:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010643a:	e9 8b f6 ff ff       	jmp    80105aca <alltraps>
...
80106441:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106446:	e9 7f f6 ff ff       	jmp    80105aca <alltraps>
...
8010644d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106452:	e9 73 f6 ff ff       	jmp    80105aca <alltraps>
...
80106459:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010645e:	e9 67 f6 ff ff       	jmp    80105aca <alltraps>
...
80106465:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010646a:	e9 5b f6 ff ff       	jmp    80105aca <alltraps>
...
80106471:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106476:	e9 4f f6 ff ff       	jmp    80105aca <alltraps>
...
8010647d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106482:	e9 43 f6 ff ff       	jmp    80105aca <alltraps>
...
80106489:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010648e:	e9 37 f6 ff ff       	jmp    80105aca <alltraps>
...
80106495:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010649a:	e9 2b f6 ff ff       	jmp    80105aca <alltraps>
...
801064a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801064a6:	e9 1f f6 ff ff       	jmp    80105aca <alltraps>
...
801064ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064b2:	e9 13 f6 ff ff       	jmp    80105aca <alltraps>
...
801064b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064be:	e9 07 f6 ff ff       	jmp    80105aca <alltraps>
...
801064c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064ca:	e9 fb f5 ff ff       	jmp    80105aca <alltraps>
...
801064d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064d6:	e9 ef f5 ff ff       	jmp    80105aca <alltraps>
...
801064dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801064e2:	e9 e3 f5 ff ff       	jmp    80105aca <alltraps>
...
801064e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801064ee:	e9 d7 f5 ff ff       	jmp    80105aca <alltraps>
...
801064f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064fa:	e9 cb f5 ff ff       	jmp    80105aca <alltraps>
...
80106501:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106506:	e9 bf f5 ff ff       	jmp    80105aca <alltraps>
...
8010650d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106512:	e9 b3 f5 ff ff       	jmp    80105aca <alltraps>
...
80106519:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010651e:	e9 a7 f5 ff ff       	jmp    80105aca <alltraps>
...
80106525:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010652a:	e9 9b f5 ff ff       	jmp    80105aca <alltraps>
...
80106531:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106536:	e9 8f f5 ff ff       	jmp    80105aca <alltraps>
...
8010653d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106542:	e9 83 f5 ff ff       	jmp    80105aca <alltraps>
...
80106549:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010654e:	e9 77 f5 ff ff       	jmp    80105aca <alltraps>
...
80106555:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010655a:	e9 6b f5 ff ff       	jmp    80105aca <alltraps>
...
80106561:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106566:	e9 5f f5 ff ff       	jmp    80105aca <alltraps>
...
8010656d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106572:	e9 53 f5 ff ff       	jmp    80105aca <alltraps>
...
80106579:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010657e:	e9 47 f5 ff ff       	jmp    80105aca <alltraps>
...
80106585:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010658a:	e9 3b f5 ff ff       	jmp    80105aca <alltraps>
...
80106591:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106596:	e9 2f f5 ff ff       	jmp    80105aca <alltraps>
...
8010659d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801065a2:	e9 23 f5 ff ff       	jmp    80105aca <alltraps>
...
801065a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065ae:	e9 17 f5 ff ff       	jmp    80105aca <alltraps>
...
801065b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065ba:	e9 0b f5 ff ff       	jmp    80105aca <alltraps>
...
801065c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065c6:	e9 ff f4 ff ff       	jmp    80105aca <alltraps>
...
801065cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065d2:	e9 f3 f4 ff ff       	jmp    80105aca <alltraps>
...
801065d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065de:	e9 e7 f4 ff ff       	jmp    80105aca <alltraps>
...
801065e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801065ea:	e9 db f4 ff ff       	jmp    80105aca <alltraps>
...
801065f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065f6:	e9 cf f4 ff ff       	jmp    80105aca <alltraps>
...
801065fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106602:	e9 c3 f4 ff ff       	jmp    80105aca <alltraps>
...
80106609:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010660e:	e9 b7 f4 ff ff       	jmp    80105aca <alltraps>
...
80106615:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010661a:	e9 ab f4 ff ff       	jmp    80105aca <alltraps>
...
80106621:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106626:	e9 9f f4 ff ff       	jmp    80105aca <alltraps>
...
8010662d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106632:	e9 93 f4 ff ff       	jmp    80105aca <alltraps>
...
80106639:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010663e:	e9 87 f4 ff ff       	jmp    80105aca <alltraps>
...
80106645:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010664a:	e9 7b f4 ff ff       	jmp    80105aca <alltraps>
...
80106651:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106656:	e9 6f f4 ff ff       	jmp    80105aca <alltraps>
...
8010665d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106662:	e9 63 f4 ff ff       	jmp    80105aca <alltraps>
...
80106669:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010666e:	e9 57 f4 ff ff       	jmp    80105aca <alltraps>
...
80106675:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010667a:	e9 4b f4 ff ff       	jmp    80105aca <alltraps>
...
80106681:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106686:	e9 3f f4 ff ff       	jmp    80105aca <alltraps>
...
8010668d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106692:	e9 33 f4 ff ff       	jmp    80105aca <alltraps>
...
80106699:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010669e:	e9 27 f4 ff ff       	jmp    80105aca <alltraps>
...
801066a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801066aa:	e9 1b f4 ff ff       	jmp    80105aca <alltraps>
...
801066b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066b6:	e9 0f f4 ff ff       	jmp    80105aca <alltraps>
...
801066bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066c2:	e9 03 f4 ff ff       	jmp    80105aca <alltraps>
...
801066c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066ce:	e9 f7 f3 ff ff       	jmp    80105aca <alltraps>
...
801066d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066da:	e9 eb f3 ff ff       	jmp    80105aca <alltraps>
...
801066e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801066e6:	e9 df f3 ff ff       	jmp    80105aca <alltraps>
...
801066ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066f2:	e9 d3 f3 ff ff       	jmp    80105aca <alltraps>
...
801066f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066fe:	e9 c7 f3 ff ff       	jmp    80105aca <alltraps>
...
80106705:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010670a:	e9 bb f3 ff ff       	jmp    80105aca <alltraps>
...
80106711:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106716:	e9 af f3 ff ff       	jmp    80105aca <alltraps>
...
8010671d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106722:	e9 a3 f3 ff ff       	jmp    80105aca <alltraps>
...
80106729:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010672e:	e9 97 f3 ff ff       	jmp    80105aca <alltraps>
...
80106735:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010673a:	e9 8b f3 ff ff       	jmp    80105aca <alltraps>
...
80106741:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106746:	e9 7f f3 ff ff       	jmp    80105aca <alltraps>
...
8010674d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106752:	e9 73 f3 ff ff       	jmp    80105aca <alltraps>
...
80106759:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010675e:	e9 67 f3 ff ff       	jmp    80105aca <alltraps>
...
80106765:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010676a:	e9 5b f3 ff ff       	jmp    80105aca <alltraps>
...
80106771:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106776:	e9 4f f3 ff ff       	jmp    80105aca <alltraps>
...
8010677d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106782:	e9 43 f3 ff ff       	jmp    80105aca <alltraps>
...
80106789:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010678e:	e9 37 f3 ff ff       	jmp    80105aca <alltraps>
...
80106795:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010679a:	e9 2b f3 ff ff       	jmp    80105aca <alltraps>
...
801067a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801067a6:	e9 1f f3 ff ff       	jmp    80105aca <alltraps>
...
801067ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067b2:	e9 13 f3 ff ff       	jmp    80105aca <alltraps>
...
801067b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067be:	e9 07 f3 ff ff       	jmp    80105aca <alltraps>
...
801067c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067ca:	e9 fb f2 ff ff       	jmp    80105aca <alltraps>
...
801067d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067d6:	e9 ef f2 ff ff       	jmp    80105aca <alltraps>
...
801067dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801067e2:	e9 e3 f2 ff ff       	jmp    80105aca <alltraps>
...
801067e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801067ee:	e9 d7 f2 ff ff       	jmp    80105aca <alltraps>
...
801067f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067fa:	e9 cb f2 ff ff       	jmp    80105aca <alltraps>
...
80106801:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106806:	e9 bf f2 ff ff       	jmp    80105aca <alltraps>
...
8010680d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106812:	e9 b3 f2 ff ff       	jmp    80105aca <alltraps>
...
80106819:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010681e:	e9 a7 f2 ff ff       	jmp    80105aca <alltraps>
...
80106825:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010682a:	e9 9b f2 ff ff       	jmp    80105aca <alltraps>
...
80106831:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106836:	e9 8f f2 ff ff       	jmp    80105aca <alltraps>
...
8010683d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106842:	e9 83 f2 ff ff       	jmp    80105aca <alltraps>
...
80106849:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010684e:	e9 77 f2 ff ff       	jmp    80105aca <alltraps>
...
80106855:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010685a:	e9 6b f2 ff ff       	jmp    80105aca <alltraps>
...
80106861:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106866:	e9 5f f2 ff ff       	jmp    80105aca <alltraps>
...
8010686d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106872:	e9 53 f2 ff ff       	jmp    80105aca <alltraps>
...
80106879:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010687e:	e9 47 f2 ff ff       	jmp    80105aca <alltraps>
...
80106885:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010688a:	e9 3b f2 ff ff       	jmp    80105aca <alltraps>
...
80106891:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106896:	e9 2f f2 ff ff       	jmp    80105aca <alltraps>
...
8010689d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801068a2:	e9 23 f2 ff ff       	jmp    80105aca <alltraps>
...
801068a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068ae:	e9 17 f2 ff ff       	jmp    80105aca <alltraps>
...
801068b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068ba:	e9 0b f2 ff ff       	jmp    80105aca <alltraps>
...
801068c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068c6:	e9 ff f1 ff ff       	jmp    80105aca <alltraps>
...
801068cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068d2:	e9 f3 f1 ff ff       	jmp    80105aca <alltraps>
...
801068d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068de:	e9 e7 f1 ff ff       	jmp    80105aca <alltraps>
...
801068e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801068ea:	e9 db f1 ff ff       	jmp    80105aca <alltraps>
...
801068f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068f6:	e9 cf f1 ff ff       	jmp    80105aca <alltraps>
...
801068fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106902:	e9 c3 f1 ff ff       	jmp    80105aca <alltraps>
...
80106909:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010690e:	e9 b7 f1 ff ff       	jmp    80105aca <alltraps>
...
80106915:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010691a:	e9 ab f1 ff ff       	jmp    80105aca <alltraps>
...
80106921:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106926:	e9 9f f1 ff ff       	jmp    80105aca <alltraps>
...
8010692d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106932:	e9 93 f1 ff ff       	jmp    80105aca <alltraps>
...
80106939:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010693e:	e9 87 f1 ff ff       	jmp    80105aca <alltraps>
...
80106945:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010694a:	e9 7b f1 ff ff       	jmp    80105aca <alltraps>
...
80106951:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106956:	e9 6f f1 ff ff       	jmp    80105aca <alltraps>
...
8010695d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106962:	e9 63 f1 ff ff       	jmp    80105aca <alltraps>
...
80106969:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010696e:	e9 57 f1 ff ff       	jmp    80105aca <alltraps>
...
80106975:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010697a:	e9 4b f1 ff ff       	jmp    80105aca <alltraps>
...
80106981:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106986:	e9 3f f1 ff ff       	jmp    80105aca <alltraps>
...
8010698d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106992:	e9 33 f1 ff ff       	jmp    80105aca <alltraps>
...
80106999:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010699e:	e9 27 f1 ff ff       	jmp    80105aca <alltraps>
...
801069a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801069aa:	e9 1b f1 ff ff       	jmp    80105aca <alltraps>
...
801069b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069b6:	e9 0f f1 ff ff       	jmp    80105aca <alltraps>
...
801069bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069c2:	e9 03 f1 ff ff       	jmp    80105aca <alltraps>
...
801069c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069ce:	e9 f7 f0 ff ff       	jmp    80105aca <alltraps>
...
801069d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069da:	e9 eb f0 ff ff       	jmp    80105aca <alltraps>
...
801069e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801069e6:	e9 df f0 ff ff       	jmp    80105aca <alltraps>
...
801069ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069f2:	e9 d3 f0 ff ff       	jmp    80105aca <alltraps>
...
801069f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069fe:	e9 c7 f0 ff ff       	jmp    80105aca <alltraps>
...
80106a05:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a0a:	e9 bb f0 ff ff       	jmp    80105aca <alltraps>
...
80106a11:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a16:	e9 af f0 ff ff       	jmp    80105aca <alltraps>
...
80106a1d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a22:	e9 a3 f0 ff ff       	jmp    80105aca <alltraps>
...
80106ab9:	e8 02 ba ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
80106acf:	68 a6 78 10 80       	push   $0x801078a6
...
80106b5e:	e8 1d bb ff ff       	call   80102680 <kalloc>
...
80106b75:	e8 f6 db ff ff       	call   80104770 <memset>
...
80106bbd:	68 f0 7e 10 80       	push   $0x80107ef0
...
80106bd3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106bd6:	e8 85 cd ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106c60:	a1 c4 56 11 80       	mov    0x801156c4,%eax
...
80106c94:	0f 84 c2 00 00 00    	je     80106d5c <switchuvm+0xec>
  pushcli();
80106c9a:	e8 c1 d8 ff ff       	call   80104560 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c9f:	e8 5c cc ff ff       	call   80103900 <mycpu>
80106ca4:	89 c3                	mov    %eax,%ebx
80106ca6:	e8 55 cc ff ff       	call   80103900 <mycpu>
80106cab:	89 c7                	mov    %eax,%edi
80106cad:	e8 4e cc ff ff       	call   80103900 <mycpu>
80106cb2:	83 c7 08             	add    $0x8,%edi
80106cb5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cb8:	e8 43 cc ff ff       	call   80103900 <mycpu>
...
80106d1f:	e8 dc cb ff ff       	call   80103900 <mycpu>
80106d24:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d27:	e8 d4 cb ff ff       	call   80103900 <mycpu>
...
80106d9b:	77 4b                	ja     80106de8 <inituvm+0x68>
  mem = kalloc();
80106d9d:	e8 de b8 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106daf:	e8 bc d9 ff ff       	call   80104770 <memset>
...
80106de2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106de3:	e9 28 da ff ff       	jmp    80104810 <memmove>
    panic("inituvm: more than a page");
80106de8:	83 ec 0c             	sub    $0xc,%esp
80106deb:	68 35 7f 10 80       	push   $0x80107f35
...
80106e50:	68 4f 7f 10 80       	push   $0x80107f4f
...
80106e9e:	e8 ed ab ff ff       	call   80101a90 <readi>
...
80106ed8:	68 f0 7f 10 80       	push   $0x80107ff0
...
80106f3b:	e8 30 d8 ff ff       	call   80104770 <memset>
...
80106f69:	76 48                	jbe    80106fb3 <allocuvm+0xc3>
    mem = kalloc();
80106f6b:	e8 10 b7 ff ff       	call   80102680 <kalloc>
...
80106f79:	68 6d 7f 10 80       	push   $0x80107f6d
...
80106fdb:	68 85 7f 10 80       	push   $0x80107f85
...
80107000:	e8 bb b4 ff ff       	call   801024c0 <kfree>
      return 0;
...
8010709e:	e8 1d b4 ff ff       	call   801024c0 <kfree>
...
801070b3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801070b4:	e9 07 b4 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
801070b9:	83 ec 0c             	sub    $0xc,%esp
801070bc:	68 a1 7f 10 80       	push   $0x80107fa1
...
801070e3:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
801070e8:	68 00 10 00 00       	push   $0x1000
801070ed:	6a 00                	push   $0x0
801070ef:	50                   	push   %eax
801070f0:	e8 7b d6 ff ff       	call   80104770 <memset>
...
8010711a:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
...
8010715b:	a3 c4 56 11 80       	mov    %eax,0x801156c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010718c:	68 b2 7f 10 80       	push   $0x80107fb2
...
801071de:	0f 84 b2 00 00 00    	je     80107296 <copyuvm+0xd6>
...
80107202:	68 bc 7f 10 80       	push   $0x80107fbc
...
80107260:	e8 ab d5 ff ff       	call   80104810 <memmove>
...
801072ac:	e8 0f b2 ff ff       	call   801024c0 <kfree>
      goto bad;
...
801072d7:	68 d6 7f 10 80       	push   $0x80107fd6
...
80107304:	0f 84 fe 02 00 00    	je     80107608 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107390:	e8 7b d4 ff ff       	call   80104810 <memmove>
    len -= n;
    buf += n;
...
801073bd:	0f 84 4c 02 00 00    	je     8010760f <copyout.cold>
  return &pgtab[PTX(va)];
...
8010741f:	85 f6                	test   %esi,%esi
80107421:	7e 61                	jle    80107484 <mprotect+0x74>
    return -1;

  struct proc* curproc = myproc();
80107423:	e8 58 c5 ff ff       	call   80103980 <myproc>
  for(int i = 0; i < len; i++){
80107428:	31 d2                	xor    %edx,%edx
  struct proc* curproc = myproc();
8010742a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    char* aligned = uva2ka(curproc->pgdir, addr);
8010742d:	8b 48 04             	mov    0x4(%eax),%ecx
80107430:	eb 21                	jmp    80107453 <mprotect+0x43>
80107432:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return (char*)P2V(PTE_ADDR(*pte));
80107438:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (aligned == 0){
8010743d:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80107442:	74 40                	je     80107484 <mprotect+0x74>
  for(int i = 0; i < len; i++){
80107444:	8d 42 01             	lea    0x1(%edx),%eax
      return -1;
    } 
    addr+=PGSIZE;
80107447:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(int i = 0; i < len; i++){
8010744d:	39 c6                	cmp    %eax,%esi
8010744f:	74 47                	je     80107498 <mprotect+0x88>
80107451:	89 c2                	mov    %eax,%edx
  pde = &pgdir[PDX(va)];
80107453:	89 d8                	mov    %ebx,%eax
80107455:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107458:	8b 04 81             	mov    (%ecx,%eax,4),%eax
8010745b:	a8 01                	test   $0x1,%al
8010745d:	0f 84 b3 01 00 00    	je     80107616 <mprotect.cold>
  return &pgtab[PTX(va)];
80107463:	89 df                	mov    %ebx,%edi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107465:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
8010746a:	c1 ef 0c             	shr    $0xc,%edi
8010746d:	81 e7 ff 03 00 00    	and    $0x3ff,%edi
  if((*pte & PTE_P) == 0)
80107473:	8b 84 b8 00 00 00 80 	mov    -0x80000000(%eax,%edi,4),%eax
  if((*pte & PTE_U) == 0)
8010747a:	89 c7                	mov    %eax,%edi
8010747c:	83 e7 05             	and    $0x5,%edi
8010747f:	83 ff 05             	cmp    $0x5,%edi
80107482:	74 b4                	je     80107438 <mprotect+0x28>
...
80107491:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80107498:	89 d8                	mov    %ebx,%eax
  for(int i = 0; i < len; i++){
8010749a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010749d:	31 f6                	xor    %esi,%esi
  pde = &pgdir[PDX(va)];
8010749f:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801074a2:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801074a5:	a8 01                	test   $0x1,%al
801074a7:	0f 84 70 01 00 00    	je     8010761d <mprotect.cold+0x7>
  return &pgtab[PTX(va)];
801074ad:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801074af:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    addr += PGSIZE; // move to next page 
801074b4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  return &pgtab[PTX(va)];
801074ba:	c1 e9 0a             	shr    $0xa,%ecx
801074bd:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
    *x = *x & ~PTE_W; // set the bit to be read only
801074c3:	83 a4 08 00 00 00 80 	andl   $0xfffffffd,-0x80000000(%eax,%ecx,1)
801074ca:	fd 
  for(int i = 0; i < len; i++){
801074cb:	8d 46 01             	lea    0x1(%esi),%eax
801074ce:	39 f2                	cmp    %esi,%edx
801074d0:	74 1e                	je     801074f0 <mprotect+0xe0>
  lcr3(V2P(curproc->pgdir));
801074d2:	8b 4f 04             	mov    0x4(%edi),%ecx
801074d5:	89 c6                	mov    %eax,%esi
  pde = &pgdir[PDX(va)];
801074d7:	89 d8                	mov    %ebx,%eax
801074d9:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801074dc:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801074df:	a8 01                	test   $0x1,%al
801074e1:	75 ca                	jne    801074ad <mprotect+0x9d>
801074e3:	e9 35 01 00 00       	jmp    8010761d <mprotect.cold+0x7>
801074e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801074ef:	90                   	nop
  lcr3(V2P(curproc->pgdir));
801074f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801074f3:	8b 40 04             	mov    0x4(%eax),%eax
801074f6:	05 00 00 00 80       	add    $0x80000000,%eax
801074fb:	0f 22 d8             	mov    %eax,%cr3
}
801074fe:	83 c4 1c             	add    $0x1c,%esp
  return 0;
...
80107519:	8b 75 0c             	mov    0xc(%ebp),%esi
8010751c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (len < 1) // if length is invalid
8010751f:	85 f6                	test   %esi,%esi
80107521:	7e 61                	jle    80107584 <munprotect+0x74>
    return -1;

  struct proc* curproc = myproc();
80107523:	e8 58 c4 ff ff       	call   80103980 <myproc>
  for(int i = 0; i < len; i++){
80107528:	31 d2                	xor    %edx,%edx
  struct proc* curproc = myproc();
8010752a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    char* aligned = uva2ka(curproc->pgdir, addr);
8010752d:	8b 48 04             	mov    0x4(%eax),%ecx
80107530:	eb 21                	jmp    80107553 <munprotect+0x43>
80107532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return (char*)P2V(PTE_ADDR(*pte));
80107538:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (aligned == 0){
8010753d:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80107542:	74 40                	je     80107584 <munprotect+0x74>
  for(int i = 0; i < len; i++){
80107544:	8d 42 01             	lea    0x1(%edx),%eax
      return -1;
    } 
    addr+=PGSIZE;
80107547:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(int i = 0; i < len; i++){
8010754d:	39 c6                	cmp    %eax,%esi
8010754f:	74 47                	je     80107598 <munprotect+0x88>
80107551:	89 c2                	mov    %eax,%edx
  pde = &pgdir[PDX(va)];
80107553:	89 d8                	mov    %ebx,%eax
80107555:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107558:	8b 04 81             	mov    (%ecx,%eax,4),%eax
8010755b:	a8 01                	test   $0x1,%al
8010755d:	0f 84 c1 00 00 00    	je     80107624 <munprotect.cold>
  return &pgtab[PTX(va)];
80107563:	89 df                	mov    %ebx,%edi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107565:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
8010756a:	c1 ef 0c             	shr    $0xc,%edi
8010756d:	81 e7 ff 03 00 00    	and    $0x3ff,%edi
  if((*pte & PTE_P) == 0)
80107573:	8b 84 b8 00 00 00 80 	mov    -0x80000000(%eax,%edi,4),%eax
  if((*pte & PTE_U) == 0)
8010757a:	89 c7                	mov    %eax,%edi
8010757c:	83 e7 05             	and    $0x5,%edi
8010757f:	83 ff 05             	cmp    $0x5,%edi
80107582:	74 b4                	je     80107538 <munprotect+0x28>
...
80107584:	83 c4 1c             	add    $0x1c,%esp
    return -1;
...
80107591:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80107598:	89 d8                	mov    %ebx,%eax
  for(int i = 0; i < len; i++){
8010759a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010759d:	31 f6                	xor    %esi,%esi
  pde = &pgdir[PDX(va)];
8010759f:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801075a2:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801075a5:	a8 01                	test   $0x1,%al
801075a7:	0f 84 7e 00 00 00    	je     8010762b <munprotect.cold+0x7>
  return &pgtab[PTX(va)];
801075ad:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801075af:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    addr += PGSIZE; // move to next page 
801075b4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  return &pgtab[PTX(va)];
801075ba:	c1 e9 0a             	shr    $0xa,%ecx
801075bd:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
    *x = *x | PTE_W; // set the bit to be readable & writable
801075c3:	83 8c 08 00 00 00 80 	orl    $0x2,-0x80000000(%eax,%ecx,1)
801075ca:	02 
  for(int i = 0; i < len; i++){
801075cb:	8d 46 01             	lea    0x1(%esi),%eax
801075ce:	39 f2                	cmp    %esi,%edx
801075d0:	74 1e                	je     801075f0 <munprotect+0xe0>
  lcr3(V2P(curproc->pgdir));
801075d2:	8b 4f 04             	mov    0x4(%edi),%ecx
801075d5:	89 c6                	mov    %eax,%esi
  pde = &pgdir[PDX(va)];
801075d7:	89 d8                	mov    %ebx,%eax
801075d9:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801075dc:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801075df:	a8 01                	test   $0x1,%al
801075e1:	75 ca                	jne    801075ad <munprotect+0x9d>
801075e3:	e9 43 00 00 00       	jmp    8010762b <munprotect.cold+0x7>
801075e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801075ef:	90                   	nop
  lcr3(V2P(curproc->pgdir));
801075f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801075f3:	8b 40 04             	mov    0x4(%eax),%eax
801075f6:	05 00 00 00 80       	add    $0x80000000,%eax
801075fb:	0f 22 d8             	mov    %eax,%cr3
}
801075fe:	83 c4 1c             	add    $0x1c,%esp
  return 0;
80107601:	31 c0                	xor    %eax,%eax
}
80107603:	5b                   	pop    %ebx
80107604:	5e                   	pop    %esi
80107605:	5f                   	pop    %edi
...
80107608 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107608:	a1 00 00 00 00       	mov    0x0,%eax
8010760d:	0f 0b                	ud2    

8010760f <copyout.cold>:
8010760f:	a1 00 00 00 00       	mov    0x0,%eax
80107614:	0f 0b                	ud2    

80107616 <mprotect.cold>:
80107616:	a1 00 00 00 00       	mov    0x0,%eax
8010761b:	0f 0b                	ud2    
    *x = *x & ~PTE_W; // set the bit to be read only
8010761d:	a1 00 00 00 00       	mov    0x0,%eax
80107622:	0f 0b                	ud2    

80107624 <munprotect.cold>:
  if((*pte & PTE_P) == 0)
80107624:	a1 00 00 00 00       	mov    0x0,%eax
80107629:	0f 0b                	ud2    
    *x = *x | PTE_W; // set the bit to be readable & writable
8010762b:	a1 00 00 00 00       	mov    0x0,%eax
80107630:	0f 0b                	ud2    

...
printint(int fd, int xx, int base, int sgn)
{
 ...
 328:	0f b6 92 b8 06 00 00 	movzbl 0x6b8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 3f5:	ff 24 85 60 06 00 00 	jmp    *0x660(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 45a:	75 15                	jne    471 <printf+0xfa>
          s = "(null)";
 45c:	be 57 06 00 00       	mov    $0x657,%esi
...
free(void *ap)
{
 ...
 4e9:	a1 64 09 00 00       	mov    0x964,%eax
 ...
 525:	89 08                	mov    %ecx,(%eax)
  freep = p;
 527:	a3 64 09 00 00       	mov    %eax,0x964
}
 52c:	5b                   	pop    %ebx
 52d:	5e                   	pop    %esi
 52e:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 584:	e8 54 ff ff ff       	call   4dd <free>
  return freep;
 589:	a1 64 09 00 00       	mov    0x964,%eax
...
malloc(uint nbytes)
{
 ...
 5ad:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5b0:	8b 0d 64 09 00 00    	mov    0x964,%ecx
 ...
 5bc:	eb 4a                	jmp    608 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 5be:	c7 05 64 09 00 00 68 	movl   $0x968,0x964
 5c5:	09 00 00 
 5c8:	c7 05 68 09 00 00 68 	movl   $0x968,0x968
 5cf:	09 00 00 
    base.s.size = 0;
 5d2:	c7 05 6c 09 00 00 00 	movl   $0x0,0x96c
 5d9:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5dc:	b9 68 09 00 00       	mov    $0x968,%ecx
 ...
 5ed:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5f0:	89 0d 64 09 00 00    	mov    %ecx,0x964
      return (void*)(p + 1);
 ...
 60d:	73 d4                	jae    5e3 <malloc+0x46>
    if(p == freep)
 60f:	39 05 64 09 00 00    	cmp    %eax,0x964
